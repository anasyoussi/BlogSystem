                                    ...
                                    @foreach($posts as $post)
                                        <tr role="row" class="odd">
                                            ...
                                            <td class="text-center inlineBtn">
                                                ...
                                                <a href="{{ route('admin.post.show', $post) }}" class="btn btn-success btn-xs waves-effect mr-2">
                                                    <i class="material-icons">visibility</i>
                                                </a>  

                                                <a href="{{ route('admin.post.edit', $post) }}" class="btn btn-primary btn-xs waves-effect mr-1">
