                                    ...
                                    @forelse($tags as $tag)
                                        <tr role="row" class="odd">
                                            ...
                                            <td class="text-center inlineBtn">
                                                ...
                                                <a href="{{ route('admin.tag.edit', $tag->id) }}" class="btn btn-xs btn-primary waves-effect mr-1">
                                                ...
                                                <form id="delete-form-{{ $tag->id }}" method="post" action="{{ route('admin.tag.destroy', $tag->id) }}" sqtyle="display: none;">
                                                    @csrf 
                                                    @method('delete')
                                                </form>
